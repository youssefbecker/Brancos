...
App::addScript("assets/js/pages/addGroupeContact.js", true, true);
App::setTitle("Contacts de $groupe->nom");
            ...
            <div class="ui-card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="col-md-6">
                                <h4 class="heading"><?= "Groupe $groupe->nom"; ?> <small>(<?= thousand($nbre->Total); ?>)</small></h4>
                            </div>
                            <div class="col-md-6">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                <form action="<?= App::url("groupes/contact/add?id=".$groupe->id) ?>" method="post" id="addContactForm">
