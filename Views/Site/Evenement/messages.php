                            ...
                            <table class="col-md-12 table table-striped table-hover table-responsive">
                                ...
                                if ($rappels) {
                                    foreach ($rappels as $rappel) {
                                        ...
                                        echo '
                                              <tr>
                                                  <td class="text-center">' .DateParser::DateShort($rappel->created_at,1) . '</td> 
                                                  <td class="text-center"><small>' . $rappel->message . '</small></td>
                                                  <td class="text-center">
                                                      <div class="btn-group">
                                                          ...
                                                          <li>
                                                          <a href="#modalEditContact" data-toggle="modal" data-message="'.$rappel->message.'" data-id="' . $rappel->id . '" data-date="' . date(DATE_FORMAT,strtotime($rappel->date)) . '" class="editButton">Modifier</a>
                                                          </li>
                                                          ' . $valAction . '      
                                                          </ul>
                                                      </div>
                                    ...
                                    echo ' <tr class=" mt-5"> <td colspan="4" class="text-center text-danger pt-4">Liste des rappels vide</td></tr>';
                                    }
                                    ?>
                                </tbody>
