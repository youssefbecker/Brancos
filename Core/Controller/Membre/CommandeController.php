...
class CommandeController extends MembreController {

    public function commander(){
        $user = $this->user;
        $setting = Settings::find(1);
        $this->render('site.commande.commander',compact('setting','user'));
    }
    ...
    public function commandes(){
        ...
        $this->render('site.commande.commandes',compact('setting','user','commandes', 'nbre', 'nbrePages', 'contactsMessage'));
    }
    ...
    public function detailsCommande(){
        ...
        if(isset($_POST['id'])&&!empty($_POST['id'])){
            ...
            if ($command){
                ...
                $valDevis = ($etat->etat!=0&&$command->etat!=3)?'
                                <tr>
                                    <td class="text-left">Devis</td>
                                    <td class="text-center"><a target="_blank" href="'.FileHelper::url($command->devis).'" class="">Visualiser</a></td>
                                </tr>':'';
                $content = '
                    <div class="panel">
                        <div class="panel-body">
                            <table class="table table-hover table-bordered table-striped m-t-sm">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><a target="_blank" href="'.FileHelper::url($command->charge).'" class="">Visualiser</a></td>
                                </tr>
                                '.$valDevis.'
                                </tboody>
                            </table>
